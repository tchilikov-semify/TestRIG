...
{ pkgs ? import <nixpkgs> {} }:
  pkgs.mkShell {
    ...
    shellHook = ''
      ...
      echo "Verilator path: $VERILATOR_INSTALL_DIR"
      ...
      export C_INCLUDE_PATH="${pkgs.spike}/include:$C_INCLUDE_PATH"
      export LIBRARY_PATH="${pkgs.spike}/lib:$LIBRARY_PATH"
    '';
  }
EOF

# Enter nix shell
nix-shell --run ./testrig_install_nix_shell.sh
